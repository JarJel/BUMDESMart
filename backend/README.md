...
* **Endpoint Baru (`PUT|POST /api/v1/profile/password`)**:
  ...
  * File yang diubah:
    * [routes/api.php](file:///c:/xampp/htdocs/BumDesMartNukita/backend/routes/api.php)
    * [ProfileController.php](file:///c:/xampp/htdocs/BumDesMartNukita/backend/app/Http/Controllers/Customers/ProfileController.php)
...
* **Dukungan Pencarian Dinamis (`search` atau `q`)**:
  ...
  * File yang diubah:
    * [ProductController.php](file:///c:/xampp/htdocs/BumDesMartNukita/backend/app/Http/Controllers/Customers/ProductController.php)
...
* **Penyelarasan Nama Kolom**:
  ...
  * File yang diubah:
    * [2026_06_10_122103_create_addresses_table.php](file:///c:/xampp/htdocs/BumDesMartNukita/backend/database/migrations/2026_06_10_122103_create_addresses_table.php)
...
* **Kategori & Produk Tambahan**:
  ...
  * File yang diubah:
    * [UserSeeder.php](file:///c:/xampp/htdocs/BumDesMartNukita/backend/database/seeders/UserSeeder.php)
