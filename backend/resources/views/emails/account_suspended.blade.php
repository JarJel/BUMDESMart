...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 8px;">
        ...
        <p>Mohon maaf, kami mendeteksi adanya pelanggaran terhadap syarat dan ketentuan platform BUMDESMart sehingga akun Anda untuk sementara waktu ditangguhkan.</p>
        ...
        <p>Selama akun ditangguhkan, Anda tidak akan dapat masuk (login) ke platform BUMDESMart.</p>
