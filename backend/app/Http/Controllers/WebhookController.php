...
class WebhookController extends Controller
{
    ...
    private function createDisbursementRecord(Order $order, UmkmBankAccount $account, float $amount, string $ownerType): void
    {
        Disbursement::create([
            'order_id'       => $order->id,
            ...
            'amount'         => $amount,
            'reference_id'   => 'DISB-' . $order->order_code . '-' . $ownerType . '-' . Str::random(6),
            'status'         => 'pending',
        ]);
    }
