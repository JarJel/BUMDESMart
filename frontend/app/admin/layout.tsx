...
const NAV: NavItem[] = [
  ...
  },
  {
    href: "/admin/umkm",
    label: "Semua UMKM",
    icon: S("M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"),
  },
  {
    href: "/admin/laporan",
    label: "Laporan",
  ...
  ...(process.env.NEXT_PUBLIC_WHATSAPP_GATEWAY_ENABLED === "true" ? [
    ...
    },
    {
      ...
      label: "Antrian WA",
      icon: S("M8.25 6.75h7.5M8.25 12h7.5m-7.5 5.25h3.75M3.375 3h17.25c.621 0 1.125.504 1.125 1.125v16.5c0 .621-.504 1.125-1.125 1.125H3.375c-.621 0-1.125-.504-1.125-1.125V4.125C2.25 3.504 2.754 3 3.375 3z"),
    },
  ] : []),
  {
