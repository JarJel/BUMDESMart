                  ...
                  <>
                    ...
                    >
                      <button
                        ...
                        className="relative p-2 rounded-lg transition-colors cursor-pointer text-gray-500 hover:text-gray-700 hover:bg-gray-50 group-hover:text-red-500 group-hover:bg-red-50/50"
                        title="Wishlist"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="absolute right-0 mt-2 w-[320px] md:w-[380px] bg-white rounded-2xl border border-gray-100 shadow-2xl z-50 overflow-hidden text-left opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-out origin-top-right transform scale-95 group-hover:scale-100">
                        <div className="flex items-center justify-between p-4 border-b border-gray-50">
                          <h3 className="font-bold text-gray-900 text-sm">Wishlist Saya</h3>
                          <span className="text-[11px] px-2 py-0.5 rounded-full font-semibold text-red-700 bg-red-50">
                        ...
                        <div className="max-h-[300px] overflow-y-auto divide-y divide-gray-50">
                          {wishlistItems.length === 0 ? (
                            <div className="p-8 text-center text-gray-400">
                              <svg className="w-8 h-8 mx-auto mb-2 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/></svg>
                              <p className="text-xs font-medium">Wishlist masih kosong</p>
                            </div>
                          ) : (
                                ...
                                <div key={item.id} className="p-4 hover:bg-gray-50/50 transition-colors flex gap-3 items-center group">
                                  <div className="w-12 h-12 rounded-lg overflow-hidden flex items-center justify-center shrink-0 bg-gray-50 border border-gray-100">
                                    {imageUrl ? (
                                      ...
                                      <svg className="w-5 h-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"/></svg>
                                    )}
                                  </div>
                    ...
                    >
                      ...
                      >
                        ...
                        {cartItems.reduce((acc, item) => acc + item.quantity, 0) > 0 && (
                          <span className="absolute top-1.5 right-1.5 w-4 h-4 bg-green-600 text-[10px] font-bold text-white rounded-full flex items-center justify-center animate-pulse">
                        ...
                        {cartItems.length > 0 && (
                          <div className="p-4 bg-gray-50/50 border-t border-gray-100 space-y-3">
                            <div className="flex justify-between items-center text-xs">
                              <span className="text-gray-500">Total Belanja (Subtotal)</span>
